            ...
            <form>
                <fieldset>
                    ...
                    <div>
                        ...
                        <input class="Inputllenar user" type="text" id="cedula" pattern="[1-9][0-9]{7}"
                    ...
                    <div>
                        ...
                        <input class="Inputllenar password" id="password" type="password" minlength="8"
                    ...
                    <a class="AIngresar">
                        <button onclick="iniciarSesion()" type="button" class="ButtonIngresar">INGRESAR</button>
                    </a>
