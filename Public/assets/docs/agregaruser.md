...
<body id="inicio">
    ...
    <main>
        <Section class="SectionFormularioUsuarios">
            <form action="confirmacionuser.html">
                <fieldset>
                    <legend> REGISTRAR NUEVO USUARIO </legend>

                    <label for="">Nombre</label>
                    <input class="Inputllenar" type="text" required placeholder="Ingresar Nombre">


                    <label for="">Apellido</label>
                    <input class="Inputllenar" type="text" required placeholder="Ingresar Apellido">


                    <label for="">Cedula o Pasaporte</label>
                    <input class="Inputllenar" type="number" required pattern="[1-9][0-9]{7}"
                    ...
                    <a href="confirmacionuser.html" class="AEnviar">
